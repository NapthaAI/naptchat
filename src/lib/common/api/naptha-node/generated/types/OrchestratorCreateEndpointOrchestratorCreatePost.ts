...
export type OrchestratorCreateEndpointOrchestratorCreatePostMutationRequest =
	OrchestratorDeploymentInput;

export type OrchestratorCreateEndpointOrchestratorCreatePostMutationResponse =
