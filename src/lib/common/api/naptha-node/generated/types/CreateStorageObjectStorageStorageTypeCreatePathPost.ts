...
export type CreateStorageObjectStorageStorageTypeCreatePathPostMutationRequest =
	BodyCreateStorageObjectStorageStorageTypeCreatePathPost;

export type CreateStorageObjectStorageStorageTypeCreatePathPostMutationResponse =
