...
export type EnvironmentCreateEndpointEnvironmentCreatePostMutationRequest =
	EnvironmentDeploymentInput;

export type EnvironmentCreateEndpointEnvironmentCreatePostMutationResponse =
