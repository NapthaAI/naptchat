...
export async function chatCompletionsEndpointInferenceChatCompletionsPost(
	...
	config: Partial<
		RequestConfig<ChatCompletionsEndpointInferenceChatCompletionsPostMutationRequest>
	> = {},
) {
	...
	>({
		method: "POST",
		url: getChatCompletionsEndpointInferenceChatCompletionsPostUrl().toString(),
		params,
		data,
		...config,
	});
