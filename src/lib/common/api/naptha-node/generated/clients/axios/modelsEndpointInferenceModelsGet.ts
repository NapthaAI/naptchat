 ...
 */
export async function modelsEndpointInferenceModelsGet(
	params?: ModelsEndpointInferenceModelsGetQueryParams,
	config: Partial<RequestConfig> = {},
) {
	const res = await client<
		ModelsEndpointInferenceModelsGetQueryResponse,
		ResponseErrorConfig<ModelsEndpointInferenceModelsGet422>,
		unknown
	>({
		method: "GET",
